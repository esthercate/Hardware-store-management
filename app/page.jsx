...
export default function Home() {
  return (
    <div className='flex flex-col px-12 py-6 w-full h-screen gap-10'>
      ...
      <div className='flex justify-center w-full h-full'>
        <div className='flex flex-col items-center gap-10 w-1/2'>
          <h1 className='flex flex-col text-3xl font-bold'>Manage your stock <span>easier and simple</span></h1>
          <p className='text-sm text-center'>Lorem int qui commodo velit voluptate ullamco fugiat. Ullamco labore Lorem aute eiusmod consequat. Enim nostrud proident fugiat consectetur. Cillum in dolor Lorem eu exercitation velit mollit consequat laboris.</p>
