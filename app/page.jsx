...
export default function Home() {
  return (
    <div className='flex flex-col px-12 py-6 w-full h-screen gap-10'>
      ...
      <div className='flex items-center gap-16 w-full h-full'>
        <div className='flex flex-col gap-10 w-1/2'>
          <h1 className='text-3xl font-bold'>Manage your inventory easily</h1>
          <p>Lorem int qui commodo velit voluptate ullamco fugiat. Ullamco labore Lorem aute eiusmod consequat. Enim nostrud proident fugiat consectetur. Cillum in dolor Lorem eu exercitation velit mollit consequat laboris.</p>
